...
<head>
    ...
    <meta name="author" content="Jorge Oliveira, DGTI">
    <meta name="generator" content="Hugo 0.122.0">

    <title>Gestão - DGTI</title>
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Gestão - DGTI</a>
            ...
            <div class="table-responsive small">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td>irrelevant</td>
                        <td>text</td>
                        <td>visual</td><script src="/docs/5.3/assets/js/color-modes.js"></script>
                    </tr>
                    <tr>
                        <td>1,014</td>
                        <td>dashboard</td>
